<template>
  <div class="container container-fluid">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="fieldset-label">DÖVİZ KURU</h2>
      </div>
      <div class="col-xs-5">
        <div class="field-group">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="fieldset-label">FİYATLAR</h2>
      </div>
      <div class="col-xs-5">
        <div class="field-group">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="fieldset-label">MEMUR MAASLARI</h2>
      </div>
      <div class="col-xs-5">
        <div class="field-group">
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="fieldset-label">KAMU İŞÇİSİ ÜCRET ARTIŞ ORANLARI</h2>
      </div>
      <div class="col-xs-5">
        <div class="field-group">
          <label class="field-label">I. Dönem</label>
